...
class AwsFunc:
    ...
    def __init__(self, cms_prefix, region='us-east-1'):
        ...
        for key in postfixes.keys():
            self.constants[key] = unicode(cms_prefix, 'utf-8') \
                + postfixes[key]
...
##TODO upload website folder
    ...
    def create_cloudfront_distribution(self):
        ...
        try:
            ...
            cloudfront.create_distribution(DistributionConfig={
                ...
                'Origins': {'Quantity': 1, 'Items': [{'Id': origin_id,
                ...
                'DefaultCacheBehavior': {
                    ...
                    'MaxTTL': 2628000,
                    'DefaultTTL': 86400,
                    'AllowedMethods': {'Quantity': 2, 'Items': ['GET',
                            'HEAD']},
                    },
    ...
    def wait_for_table(self, table):
        ...
        while table_creating and retries > 0:
            try:
                dynamodb = boto3.client('dynamodb')
                response = \
                    dynamodb.describe_table(TableName=table['TableDescription'
                        ]['TableName'])
    ...
    def update_lambda(self):
        try:
            ...
            lmda.update_function_code(FunctionName=self.constants['LAMBDA_FUNCTION'
    ...
    def create_lambda_function(self):
        ...
        lmda_role = json.dumps({'Version': '2012-10-17',
        ...
        try:
            ...
            # # TODO need to check if role exists then skip to next
    ...
    def create_rest_api(self):
        ...
        try:
            ...
            # # TODO need to check if API exists then skip to next

            print 'Creating the rest api'
            rest_api = \
                api_gateway.create_rest_api(name=self.constants['REST_API'
                    ])
            print 'Rest api created'

            self.constants['REST_API_ID'] = rest_api['id']
            rest_api_resource = \
                api_gateway.get_resources(restApiId=self.constants['REST_API_ID'
                    ])
    ...
    def api_add_post_method(self):
        try:
            ...
            api_gateway.put_method(restApiId=rest_api_id,
                                   resourceId=rest_api_root_id,
                                   httpMethod='POST',
                                   authorizationType='NONE',
                                   requestParameters={'method.request.header.Cookie': False})
            ...
            api_gateway.put_integration(
                ...
                requestTemplates={'application/json': '#if($input.params("Cookie") && $input.params("Cookie") != "") {"body": $input.body, "token": "$input.params("Cookie")"}#else{"body": $input.body}#end'
                                  },
                )
            ...
            api_gateway.put_method_response(
                ...
                httpMethod='POST',
                statusCode='200',
                responseParameters={'method.response.header.Set-Cookie': False,
            ...
            api_gateway.put_integration_response(
                ...
                httpMethod='POST',
                statusCode='200',
                responseParameters={'method.response.header.Set-Cookie': 'integration.response.body.Set-Cookie'
                                    ,
            ...
            api_gateway.put_method_response(
                ...
                httpMethod='POST',
                statusCode='400',
                responseParameters={'method.response.header.Access-Control-Allow-Credentials': False,
                                    'method.response.header.Access-Control-Allow-Origin': False},
                responseModels={'application/json': 'Empty'},
                )
    ...
    def api_add_options_method(self):
        try:
            ...
            api_gateway.put_integration(restApiId=rest_api_id,
                    resourceId=rest_api_root_id, httpMethod='OPTIONS',
                    type='MOCK',
            ...
            api_gateway.put_integration_response(
                ...
                statusCode='200',
                responseParameters={
                    'method.response.header.Access-Control-Allow-Headers': "'Content-Type,X-Amz-Date,Authorization,X-Api-Key,X-Amz-Security-Token,Cookie,Accept,Access-Control-Allow-Origin'"
                        ,
                    'method.response.header.Access-Control-Allow-Origin': "\'https://s3.amazonaws.com\'"
                        ,
                    'method.response.header.Access-Control-Allow-Credentials': "\'true\'"
    ...
    def deploy_api(self):
        try:
            ...
            api_gateway.create_deployment(restApiId=rest_api_id,
                    stageName='prod')
            ...
            lmda.add_permission(FunctionName=function_name,
    ...
    def save_constants(self):
        ...
        if not os.path.isfile('./installed.json'):
            with open('installed.json', 'w') as installed:
                installed.write(json.dumps({'1': self.cms_prefix},
    ...
    def create_api_permissions_uri(self):
        ...
        self.constants['API_PERMISSIONS_URI'] = \
            'arn:aws:execute-api:%s:%s:%s/*/POST/' % (self.region,
                AwsFunc.get_account_id(), self.constants['REST_API_ID'])
